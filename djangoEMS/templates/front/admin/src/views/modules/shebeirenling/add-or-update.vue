          ...
          <el-form-item class="input" label="分类" prop="fenlei">
              <el-input v-model="ruleForm.fenlei" 
                placeholder="分类" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="折旧率" prop="zhejiulv">
          <el-input v-model="ruleForm.zhejiulv" 
              placeholder="折旧率" clearable  :readonly="ro.zhejiulv"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="折旧率" prop="zhejiulv">
              <el-input v-model="ruleForm.zhejiulv" 
                placeholder="折旧率" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" label="生产商" prop="shengchanshang">
              <el-input v-model="ruleForm.shengchanshang" 
                placeholder="生产商" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="采购日期" prop="caigouriqi">
          <el-input v-model="ruleForm.caigouriqi" 
              placeholder="采购日期" clearable  :readonly="ro.caigouriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="采购日期" prop="caigouriqi">
              <el-input v-model="ruleForm.caigouriqi" 
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fenlei = true;
            continue;
	            	            ...
	            	            if(o=='zhejiulv'){
            this.ruleForm.zhejiulv = obj[o];
	    this.ro.zhejiulv = true;
            continue;
          }
	            	            if(o=='tupian'){
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `shebeirenling/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeirenlingCrossAddOrUpdateFlag = false;
                  this.parent.search();
