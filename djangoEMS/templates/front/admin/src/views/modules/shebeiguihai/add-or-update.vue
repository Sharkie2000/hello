        ...
        <el-col :span="12">
          ...
          >
            <el-input
              ...
              placeholder="调度备注"
              clearable
              :readonly="ro.guihaibeizhu"
            ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="调度备注" prop="guihaibeizhu">
              <el-input
                v-model="ruleForm.guihaibeizhu"
                placeholder="调度备注"
                readonly
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      obj.shuliang =
        parseFloat(obj.shuliang) + parseFloat(this.ruleForm.shuliang);
      this.$http({
        url: `${table}/update`,
        method: "post",
        data: obj,
