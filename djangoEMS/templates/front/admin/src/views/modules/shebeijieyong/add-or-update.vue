    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shengchanshang"
              placeholder="生产商"
              clearable
              :readonly="ro.shengchanshang"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.jieyongtianshu"
              placeholder="记录天数"
              clearable
              :readonly="ro.jieyongtianshu"
            ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="记录天数" prop="jieyongtianshu">
              <el-input
                v-model="ruleForm.jieyongtianshu"
                placeholder="记录天数"
                readonly
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              ...
              placeholder="记录备注"
              clearable
              :readonly="ro.jieyongbeizhu"
            ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="记录备注" prop="jieyongbeizhu">
              <el-input
                v-model="ruleForm.jieyongbeizhu"
                placeholder="记录备注"
                readonly
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        ...
        jieyongtianshu: [
          { required: true, message: "记录天数不能为空", trigger: "blur" },
          { validator: validateIntNumber, trigger: "blur" },
        ],
        jieyongriqi: [],
        jieyongbeizhu: [],
  ...
  methods: {
    ...
    init(id, type) {
      ...
      if (this.type == "info" || this.type == "else") {
        ...
        for (var o in obj) {
          ...
          if (o == "jieyongtianshu") {
            this.ruleForm.jieyongtianshu = obj[o];
            this.ro.jieyongtianshu = true;
            continue;
          }
          if (o == "jieyongriqi") {
    ...
    onSubmit() {
      ...
      //  var table="shebeijieyong"
      //  console.log(table,"提交");
