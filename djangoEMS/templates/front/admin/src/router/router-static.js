...
import center from '@/views/center'
    import shebeirenling from '@/views/modules/shebeirenling/list'
    import weixiushenbao from '@/views/modules/weixiushenbao/list'
...
const routes = [{
	...
	path: '/shebeirenling',
        name: '设备认领',
        component: shebeirenling
      }
          ,{
	path: '/weixiushenbao',
        name: '申报',
        component: weixiushenbao
      }
          ,{
	path: '/yonghu',
        name: '用户',
